...
export const enUS: AppCopy = {
  ...
  profiles: {
    ...
    resetDepsBtn: "Reset Dependencies",
    resetDepsConfirm: (name: string) => `Are you sure you want to reset dependencies for "${name}"?\n\nThis will completely remove the node_modules cache and cleanly reinstall with pnpm according to package.json.`,
    resetDepsSuccess: (msg: string) => `Profile dependencies reset and cleanly reinstalled: ${msg}`,
    resettingDeps: "Resetting dependencies and reinstalling…",
  ...
  market: {
    ...
    sortDownloads: "Most Downloads ⬇️",
    ...
    installSpecLabel: "Install Specifier",
