...
export const enUS: AppCopy = {
  ...
  profiles: {
    ...
    desktopRuntimeNote:
      "Note: these core components are deployed and maintained uniformly by the client runtime; they belong to the built-in base layer and are not counted as third-party plugins. Custom extensions installed in this Profile appear separately in the Plugins list.",
    bundleIntroPre: "The base composition is written at Profile initialization (",
    bundleIntroPost: "), defining the workbench's base UI host and system capabilities:",
    bundleBaseTag: "System core",
    copyYaml: "Copy YAML",
  },
  sessions: {
