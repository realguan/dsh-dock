...
export const t = {
  ...
  profiles: {
    ...
    resetDepsBtn: "重置依赖",
    resetDepsConfirm: (name: string) => `确定重置「${name}」的工作台依赖？\n\n将彻底清理该 Profile 的 node_modules 缓存，并根据 package.json 声明通过 pnpm 重新纯净安装。`,
    resetDepsSuccess: (msg: string) => `工作台依赖重置与纯净安装完成：${msg}`,
    resettingDeps: "正在重置依赖并重新安装…",
